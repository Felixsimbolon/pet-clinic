...
def create_kunjungan(request):
    ...
    if request.method == "POST":
        ...
        dokter_id = request.POST['dokter_hewan']
        perawat_id = request.POST['perawat_hewan']

        # Process email to format it as required
        
        # Get doctor name with "dr."
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                INSERT INTO kunjungan
                    (no_identitas_klien, nama_hewan, tipe_kunjungan, timestamp_awal, timestamp_akhir, dokter_hewan, perawat_hewan)
                VALUES (%s, %s, %s, %s, %s, %s, %s)
            """, [id_klien, nama_hewan, metode_kunjungan, waktu_mulai_penanganan, waktu_selesai_penanganan, dokter_id, perawat_id])
